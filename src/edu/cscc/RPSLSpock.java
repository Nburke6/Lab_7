 ...
 * @return pick - returns the random pick among 5 possible choices for RPSLSpock
 */
public class RPSLSpock {
    ...
    /**
     *
     * @param pick assigns a value for the chosen value of the 5 potential options and checks it for validity
     * @return returns the chosen value or a false value to check for proper user selection
     */
    ...
    /**
     *
     * @return returns a string value for pick that is randomly chosen between 0-4
     */
    ...
    /**
     *
     * @param c_pick value for the option chosen at random by the computer
     * @param h_pick value that the user has input for their choice
     * @return determines whether or not the computer has won
     */
